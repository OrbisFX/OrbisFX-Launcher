...
{
#line 129
const float2 LutBounds = (VerticalOrietation ? float2(LutRes, LutRes*LutRes) : float2(LutRes*LutRes, LutRes)) * float2((1.0 / 1920), (1.0 / 1018));
#line 131
if( any(TexCoord>=LutBounds) ) return tex2D(ReShade::BackBuffer, TexCoord).rgb;
else
{
#line 135
const float2 Gradient = TexCoord*float2(1920, 1018)/LutRes;
#line 137
float3 LUT;
