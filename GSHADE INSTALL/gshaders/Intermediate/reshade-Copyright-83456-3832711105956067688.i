...
for(int i = 1; i < 4; ++i)
{
color += tex2Dlod(Copyright_Sampler_Gauss_V, float4(texCoord + float2(sampleOffsets[i] * (GaussWeight * (GaussWeightH + 0.5)) * float2((1.0 / 1920), (1.0 / 1018)).x, 0.0), 0.0, 0.0)) * sampleWeights[i];
color += tex2Dlod(Copyright_Sampler_Gauss_V, float4(texCoord - float2(sampleOffsets[i] * (GaussWeight * (GaussWeightH + 0.5)) * float2((1.0 / 1920), (1.0 / 1018)).x, 0.0), 0.0, 0.0)) * sampleWeights[i];
}
break;
case 1:
...
#line 692
const float3 SumUV = mul (mul (mul (float3(texCoord.x, texCoord.y, 1), positionMatrix(0.5 + float(cLayer_PosX_Gauss * 0.1), 0.5 + float(cLayer_PosY_Gauss * 0.1))), rotateMatrix_Alt(0)) * float3(float2(1920, 1018), 1.0), scaleMatrix(float(float2(float2(800.0, 100.0) * ((cLayer_Scale) + (-1 + cLayer_Scale_Gauss))).x), float(float2(float2(800.0, 100.0) * ((cLayer_Scale) + (-1 + cLayer_Scale_Gauss))).y)));
...
for(int i = 1; i < 4; ++i)
{
color += tex2Dlod(Copyright_Sampler_Gauss_H, float4(texCoord + float2(0.0, sampleOffsets[i] * (GaussWeight * (GaussWeightV + 0.5)) * float2((1.0 / 1920), (1.0 / 1018)).y), 0.0, 0.0)) * sampleWeights[i];
color += tex2Dlod(Copyright_Sampler_Gauss_H, float4(texCoord - float2(0.0, sampleOffsets[i] * (GaussWeight * (GaussWeightV + 0.5)) * float2((1.0 / 1920), (1.0 / 1018)).y), 0.0, 0.0)) * sampleWeights[i];
}
break;
case 1:
...
for(int i = 1; i < 6; ++i)
{
color += tex2Dlod(Copyright_Sampler_CAb_Gauss_V, float4(texCoord + float2(sampleOffsets[i] * cLayer_CAb_Blur * float2((1.0 / 1920), (1.0 / 1018)).x, 0.0), 0.0, 0.0)) * sampleWeights[i];
color += tex2Dlod(Copyright_Sampler_CAb_Gauss_V, float4(texCoord - float2(sampleOffsets[i] * cLayer_CAb_Blur * float2((1.0 / 1920), (1.0 / 1018)).x, 0.0), 0.0, 0.0)) * sampleWeights[i];
}
return color;
}
...
#line 757
const float3 SumUV = mul (mul (mul (float3(texCoord.x, texCoord.y, 1), positionMatrix(0.5, 0.5)) * float3(float2(1920, 1018), 1.0), rotateMatrix_Alt(0)), scaleMatrix(float(float2(float2(800.0, 100.0) * cLayer_Scale).x * cLayer_ScaleX), float(float2(float2(800.0, 100.0) * cLayer_Scale).y * cLayer_ScaleY)));
...
for(int i = 1; i < 6; ++i)
{
color += tex2Dlod(Copyright_Sampler_CAb_Gauss_H, float4(texCoord + float2(0.0, sampleOffsets[i] * cLayer_CAb_Blur * float2((1.0 / 1920), (1.0 / 1018)).y), 0.0, 0.0)) * sampleWeights[i];
color += tex2Dlod(Copyright_Sampler_CAb_Gauss_H, float4(texCoord - float2(0.0, sampleOffsets[i] * cLayer_CAb_Blur * float2((1.0 / 1920), (1.0 / 1018)).y), 0.0, 0.0)) * sampleWeights[i];
}
return color;
}
...
const float3 SumUV = mul (mul (float3(texCoord.x, texCoord.y, 1), positionMatrix(0.5 + CAb_Shift.x, 0.5 + CAb_Shift.y * 1920 / 1018)), scaleMatrix(1, 1));
...
{
const float3 SumUV = mul (mul (mul (float3(texCoord.x, texCoord.y, 1), positionMatrix(float(cLayer_Mouse && RightMouseDown? MouseCoords.x * float2((1.0 / 1920), (1.0 / 1018)).x : cLayer_PosX), float(cLayer_Mouse && RightMouseDown? MouseCoords.y * float2((1.0 / 1920), (1.0 / 1018)).y : cLayer_PosY))) * float3(float2(1920, 1018), 1.0), rotateMatrix(cLayer_Rotate)), scaleMatrix(float(float2(float2(800.0, 100.0) * cLayer_Scale).x * cLayer_ScaleX), float(float2(float2(800.0, 100.0) * cLayer_Scale).y * cLayer_ScaleY)));
const float3 SumUV_Gauss = mul (mul (mul (float3(texCoord.x, texCoord.y, 1), positionMatrix(float(cLayer_Mouse && RightMouseDown? MouseCoords.x * float2((1.0 / 1920), (1.0 / 1018)).x : cLayer_PosX), float(cLayer_Mouse && RightMouseDown? MouseCoords.y * float2((1.0 / 1920), (1.0 / 1018)).y : cLayer_PosY))) * float3(float2(1920, 1018), 1.0), rotateMatrix(cLayer_Rotate)), scaleMatrix(1920, 1018));
