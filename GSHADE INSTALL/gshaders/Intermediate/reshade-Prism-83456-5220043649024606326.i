...
#line 166
float2 distortion = viewCoord*(rcp(1f+dot(K, pow_radius))-1f)/normalize(float2(1920, 1018))*0.5; 
#line 168
viewCoord = pixelPos.xy*float2((1.0 / 1920), (1.0 / 1018));
#line 170
uint evenSampleCount = min(ChromaticSamplesLimit-ChromaticSamplesLimit%2u, 128u); 
#line 172
uint totalPixelOffset = uint(ceil(length(distortion*float2(1920, 1018))));
#line 174
