...
texture texDrawARatio { Width = 1280; Height = 720; };
...
float3 result;
#line 557
sctpoint lineV1 = NewPoint(gridColorARatio, lineWidthARatio, float2(((1280 / 720) * 0.5) * 0.25, texCoord.y));
sctpoint lineH1 = NewPoint(gridColorARatio, lineWidthARatio, float2(((1280 / 720) * 0.5) * 1.75, texCoord.y));
#line 560
result = DrawPoint(background, lineV1, texCoord);
result = DrawPoint(result, lineH1, texCoord);
#line 563
...
float3 result;
#line 569
sctpoint lineV1 = NewPoint(gridColorARatio, lineWidthARatio, float2(((1280 / 720) * 0.5) * 0.35, texCoord.y));
sctpoint lineH1 = NewPoint(gridColorARatio, lineWidthARatio, float2(((1280 / 720) * 0.5) * 1.65, texCoord.y));
#line 572
result = DrawPoint(background, lineV1, texCoord);
result = DrawPoint(result, lineH1, texCoord);
#line 575
...
float3 result;
#line 581
sctpoint lineV1 = NewPoint(gridColorARatio, lineWidthARatio, float2(((1280 / 720) * 0.5) * 0.69, texCoord.y));
sctpoint lineH1 = NewPoint(gridColorARatio, lineWidthARatio, float2(((1280 / 720) * 0.5) * 1.31, texCoord.y));
#line 584
result = DrawPoint(background, lineV1, texCoord);
result = DrawPoint(result, lineH1, texCoord);
#line 587
...
float3 result;
#line 593
sctpoint lineV1 = NewPoint(gridColorARatio, lineWidthARatio, float2(((1280 / 720) * 0.5) * 0.514, texCoord.y));
sctpoint lineH1 = NewPoint(gridColorARatio, lineWidthARatio, float2(((1280 / 720) * 0.5) * 1.486, texCoord.y));
#line 596
result = DrawPoint(background, lineV1, texCoord);
result = DrawPoint(result, lineH1, texCoord);
#line 599
...
float3 result;
#line 605
sctpoint lineV1 = NewPoint(gridColorARatio, lineWidthARatio, float2(((1280 / 720) * 0.5) * 0.5, texCoord.y));
sctpoint lineH1 = NewPoint(gridColorARatio, lineWidthARatio, float2(((1280 / 720) * 0.5) * 1.5, texCoord.y));
#line 608
result = DrawPoint(background, lineV1, texCoord);
result = DrawPoint(result, lineH1, texCoord);
#line 611
...
const float2 ScaleSize = (float2(1280, 720) * cLayerVPre_Scale);
...
#line 704
float3 SumUV = mul (mul (mul (mulUV, positionMatrix) * float3(float2(1280, 720), 1.0), rotateMatrix), scaleMatrix);
