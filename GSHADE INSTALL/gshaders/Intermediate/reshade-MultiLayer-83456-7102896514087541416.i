...
#line 70 "C:\Program Files\GShade\gshade-shaders\Shaders\MultiLayer.fx"
...
#line 71 "C:\Program Files\GShade\gshade-shaders\Shaders\MultiLayer.fx"
#line 77
...
> = 0;
#line 185
texture MultiLayer_Tex <source = "LayerA.png";> { Width = 1920; Height = 1018; Format=RGBA8; };
...
const float2 ScaleSize = (float2(1920, 1018) * Layer_Scale);
...
#line 239
const float3 SumUV = mul (mul (mul (mulUV, positionMatrix) * float3(1920, 1018, 1.0), rotateMatrix), scaleMatrix);
