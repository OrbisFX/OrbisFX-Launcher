...
#line 75 "C:\Program Files\GShade\gshade-shaders\Shaders\Nostalgia.fx"
#line 97
...
{
#line 579
const float grid_position = frac(dot(texcoord, float2(1920, 1018) * 0.5) + 0.25); 
#line 582
...
{
color *= frac(texcoord.y * (1018 * 0.5)) + 0.5; 
}
if (Nostalgia_scanlines == 2)
{
float grey  = dot(color,float(1.0/3.0));
if (frac(texcoord.y * (1018 * 0.5)) >= 0.25);
