...
#line 435
if ((1280 * (1.0 / 720))>1f) 
borderCoord.x = borderCoord.x*(1280 * (1.0 / 720))+(1f-(1280 * (1.0 / 720)));
else if ((1280 * (1.0 / 720))<1f) 
borderCoord.y = borderCoord.y*(720*(1.0 / 1280))+(1f-(720*(1.0 / 1280)));
#line 440
...
#line 491
const float2 aspectScalar = 0.5/normalize(float2(1280, 720));
#line 493
...
{
#line 604
float2 orygTexCoord = (pixelPos.xy+0.5)*float2((1.0 / 1280), (1.0 / 720));
#line 606
float2 distortion = texCoord-orygTexCoord;
#line 608
uint evenSampleCount = min(ChromaticSamplesLimit-ChromaticSamplesLimit%2u, 64u); 
#line 610
uint totalPixelOffset = uint(ceil(length(T*(distortion*float2(1280, 720)))));
#line 612
