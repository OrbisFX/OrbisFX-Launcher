...
#line 108
texture FeatureCurr          { Width = 1280;   Height = 720;   Format = RG16F; MipLevels = 8; };
sampler sFeatureCurr         { Texture = FeatureCurr;  };
texture FeaturePrev          { Width = 1280;   Height = 720;   Format = RG16F; MipLevels = 8; };
sampler sFeaturePrev         { Texture = FeaturePrev;   };
#line 113
texture texMotionVectors          { Width = 1280;   Height = 720;   Format = RG16F; };
sampler sMotionVectorTex         { Texture = texMotionVectors;  };
#line 116
texture MotionTexCur7               { Width = 1280 >> 7;   Height = 720 >> 7;   Format = RGBA16F;  };
sampler sMotionTexCur7              { Texture = MotionTexCur7;};
texture MotionTexCur6               { Width = 1280 >> 6;   Height = 720 >> 6;   Format = RGBA16F;  };
sampler sMotionTexCur6              { Texture = MotionTexCur6;};
texture MotionTexCur5               { Width = 1280 >> 5;   Height = 720 >> 5;   Format = RGBA16F;  };
sampler sMotionTexCur5              { Texture = MotionTexCur5;};
texture MotionTexCur4               { Width = 1280 >> 4;   Height = 720 >> 4;   Format = RGBA16F;  };
sampler sMotionTexCur4              { Texture = MotionTexCur4;};
texture MotionTexCur3               { Width = 1280 >> 3;   Height = 720 >> 3;   Format = RGBA16F;  };
sampler sMotionTexCur3              { Texture = MotionTexCur3;};
texture MotionTexCur2               { Width = 1280 >> 2;   Height = 720 >> 2;   Format = RGBA16F;  };
sampler sMotionTexCur2              { Texture = MotionTexCur2;};
texture MotionTexCur1               { Width = 1280 >> 1;   Height = 720 >> 1;   Format = RGBA16F;  };
sampler sMotionTexCur1              { Texture = MotionTexCur1;};
texture MotionTexCur0               { Width = 1280 >> 0;   Height = 720 >> 0;   Format = RGBA16F;  };
...
{
float2 texelsize = rcp(float2(1280, 720) / exp2(mip_gcurr));
...
{
float2 texelsize = rcp(float2(1280, 720) / exp2(mip_gcurr + 1));
