...
#line 176
viewCoord.x = (texCoord.x =   vertexPos.x = vertexPosList[vertexId].x)*(1920 * (1.0 / 1018));
...
#line 192
uint blurPixelCount = uint(ceil(blurRadius*1018));
#line 194
...
float2x2(-rotationMtx[0]*(1920 * (1.0 / 1018)), rotationMtx[1]), 
float2(0f, BlurOffset) 
);
#line 284
const float2x2 pixelRoationMtx = rotationMtx*1018*0.5; 
#line 287
