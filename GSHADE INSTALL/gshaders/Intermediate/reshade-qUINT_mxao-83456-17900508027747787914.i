// qMXAO_TWO_LAYER=1
// qMXAO_SMOOTHNORMALS=1
// qMXAO_HIGH_QUALITY=0
// qMXAO_MIPLEVEL_IL=2
// qMXAO_MIPLEVEL_AO=0
// qMXAO_ENABLE_IL=0
#line 1 "unknown"
...
#line 178
texture2D qMXAO_ColorTex 	{ Width = 1920;   Height = 1018;   Format = RGBA8; MipLevels = 3+2;};
texture2D qMXAO_DepthTex 	{ Width = 1920;   Height = 1018;   Format = R16F;  MipLevels = 3+0;};
texture2D qMXAO_NormalTex	{ Width = 1920;   Height = 1018;   Format = RGBA8; MipLevels = 3+2;};
#line 182
...
#line 186
texture2D CommonTex0 	{ Width = 1920;   Height = 1018;   Format = RGBA8; };
sampler2D sCommonTex0	{ Texture = CommonTex0;	};
#line 189
texture2D CommonTex1 	{ Width = 1920;   Height = 1018;   Format = RGBA8; };
...
|| 0.25 * 0.5 * MXAO_SAMPLE_RADIUS / (tex2D(sMXAO_DepthTex, MXAO.uv.zw).x + 2.0) * 1018 < 1.0
|| MXAO.uv.z > 1.0
|| MXAO.uv.w > 1.0
) discard;
#line 385
...
float scaled_radius = MXAO_SAMPLE_RADIUS / position.z / stepshalf * 1000.0;
