...
#line 124
static const float2 ASPECT_RATIO 	= float2(1.0, 1920 * (1.0 / 1018));
static const float2 PIXEL_SIZE 		= float2((1.0 / 1920), (1.0 / 1018));
static const float2 SCREEN_SIZE 	= float2(1920, 1018);
#line 130
...
#line 138
static const int BloomTex7_LowestMip = (((1018/128 >> 1) != 0) + ((1018/128 >> 2) != 0) + ((1018/128 >> 3) != 0) + ((1018/128 >> 4) != 0) + ((1018/128 >> 5) != 0) + ((1018/128 >> 6) != 0) + ((1018/128 >> 7) != 0) + ((1018/128 >> 8) != 0) + ((1018/128 >> 9) != 0) + ((1018/128 >> 10) != 0) + ((1018/128 >> 11) != 0) + ((1018/128 >> 12) != 0) + ((1018/128 >> 13) != 0) + ((1018/128 >> 14) != 0) + ((1018/128 >> 15) != 0) + ((1018/128 >> 16) != 0));
#line 140
texture2D MXBLOOM_BloomTexSource 	{ Width = 1920/2; 	Height = 1018/2;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex1 		{ Width = 1920/2; 	Height = 1018/2;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex2			{ Width = 1920/4;  	Height = 1018/4;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex3 		{ Width = 1920/8;  	Height = 1018/8;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex4 		{ Width = 1920/16;  Height = 1018/16;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex5 		{ Width = 1920/32;  Height = 1018/32;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex6 		{ Width = 1920/64;  Height = 1018/64;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex7 		{ Width = 1920/128; Height = 1018/128;  Format = RGBA16F; MipLevels = BloomTex7_LowestMip;};
