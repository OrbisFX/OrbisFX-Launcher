...
#line 111 "C:\Program Files\GShade\gshade-shaders\Shaders\DepthSharpenStaticDof.fx"
#line 123
...
return ori;
#line 137
const float depthTL = ReShade::GetLinearizedDepth( tex + float2(-float2((1.0 / 1920), (1.0 / 1018)).x, -float2((1.0 / 1920), (1.0 / 1018)).y) ).r;
const float depthTR = ReShade::GetLinearizedDepth( tex + float2(float2((1.0 / 1920), (1.0 / 1018)).x, -float2((1.0 / 1920), (1.0 / 1018)).y) ).r;
