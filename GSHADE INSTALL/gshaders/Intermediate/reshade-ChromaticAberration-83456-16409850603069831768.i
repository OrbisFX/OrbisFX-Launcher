...
#line 43 "C:\Program Files\GShade\gshade-shaders\Shaders\ChromaticAberration.fx"
#line 48
...
#line 52
color.r = tex2D(ReShade::BackBuffer, texcoord + (float2((1.0 / 1920), (1.0 / 1018)) * Shift)).r;
color.g = colorInput.g;
color.b = tex2D(ReShade::BackBuffer, texcoord - (float2((1.0 / 1920), (1.0 / 1018)) * Shift)).b;
#line 62
